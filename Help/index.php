...
<body>
  ...
  <div class="container-fluid">
    <div class="jumbotron">
       ...
       <p>Find out how to use this system.</p>
    </div>
  </div>
  ...
  <div class="container-fluid mb-5">
    ...
    <h5 class="mt-2">Pricing and Payment</h5>
    <button type="button" class="btn btn-link text-left">Is there a delivery fee?</button><br>
    <button type="button" class="btn btn-link text-left">Can I get a refund?</button><br>
    ...
    <button type="button" class="btn btn-link text-left">Changing delivery address after order.</button><br>
